...
class QuestionSelector:
    ...
    @staticmethod
    def _select_all_questions(
        question_list: List[Dict[str, Any]], group_coupled_questions: bool
    ) -> List[Dict[str, Any]]:
    ...
    @staticmethod
    def _select_list_questions(
        question_list: List[Dict[str, Any]], question_indices: List[int], _: bool
    ) -> List[Dict[str, Any]]:
